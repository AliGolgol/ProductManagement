...
namespace Repository.Web.Controllers
{
    ...
    public class PaymentTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description")] PaymentType paymentType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description")] PaymentType paymentType)
        {
            if (ModelState.IsValid)
            {
