...
namespace ProductManagement.WebApi.DependencyResolution {
    using StructureMap;
    ...
    public class DefaultRegistry : Registry {
        ...
        public DefaultRegistry() {
            ...
            For<IUnitOfWork>()
                .Use<Repository.DataLayer.Context.ApplicationDbContext>();
            ...
            For<System.Data.Entity.DbContext>().Use(() => new Models.ApplicationDbContext());
