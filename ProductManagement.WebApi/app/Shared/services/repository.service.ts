...
export class RepositoryService {
    ...
    constructor(private _http: Http,
        ...
        this._Url = configureService.getApiURI() + 'Repositories';
    }
    ...
    add(about: IRepository): Observable<IRepository> {
    ...
    getById(id: number): Observable<IRepository> {
    ...
    update(repository: IRepository): Observable<void> {
        let headers = new Headers();
        headers.append('Content-Type', 'application/json');
        return this._http.put(this._Url + '/' + repository.Id, JSON.stringify(repository), {
            headers: headers
        })
            .map((response: Response) => {
                return;
