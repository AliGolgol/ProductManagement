...
@Component({
    selector: 'buySlip-create',
    templateUrl: 'app/BuySlips/buySlip-add.component.html',
    directives: [MODAL_DIRECTIVES, BuySlipItemListComponent],
    animations: [
        trigger('flyInOut', [
...
export class AddBuySlipComponent implements OnInit {
    ...
    insert() {
        ...
        localStorage.setItem("buySlipCreate", "ok");
        this.clicked.emit(this.buySlip);
    }
